...
class FoodItemForm(forms.ModelForm):
    class Meta:
        model = FoodItem
        fields = ('name', 'description', 'price', 'category', 'image', 'image_url', 'is_available', 'preparation_time')
        widgets = {
            ...
            'image_url': forms.URLInput(attrs={'class': 'form-control', 'placeholder': 'Or paste an image URL (e.g. https://example.com/food.jpg)'}),
